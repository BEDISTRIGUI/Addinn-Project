...
new Menu (21, 'employees', '/tools/employees', null, 'users', null, false, 20), 
new Menu (22, 'timesOff', '/tools/timesOff', null, 'check-square-o', null, false, 20), 
new Menu (23, 'chat', '/tools/chat', null, 'commenting-o', null, false, 20),
new Menu (4, 'event', '/event', null, 'bell-o', null, false, 0),

new Menu (9, 'documents', '/documents', null, 'file', null, false, 0),
new Menu (5, 'calendar', '/calendar', null, 'calendar', null, false, 0),
new Menu (6, 'settings', '/settings', null, 'gears', null, false, 0),
